...
class TypewriterAnimatedTextKit extends StatefulWidget {
  ...
  final void Function(int, bool, String) onNext;
  ...
  final void Function(int, bool, String) onNextBeforePause;
...
class _TypewriterState extends State<TypewriterAnimatedTextKit>
  ...
  void _nextAnimation() {
    ...
    if (_index > -1) {
      widget.onNext?.call(_index, isLast, _texts[_index]['text']);
    }
  ...
  void _setPause() {
    ...
    if (widget.onNextBeforePause != null)
      widget.onNextBeforePause(_index, isLast, _texts[_index]['text']);
  }
